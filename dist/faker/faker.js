...
exports.fakerUsers = Array.from({ length: 20 }).map(() => {
    return {
...
exports.fakerRestaurants = Array.from({ length: 60 }).map(() => {
    return {
        id: faker_1.faker.string.uuid(),
        ...
        latitude: faker_1.faker.location.latitude({ max: 80, min: -80, precision: 5 }),
        longitude: faker_1.faker.location.longitude({ max: 80, min: -80, precision: 5 }),
        image: 'https://picsum.photos/500/300',
        cuisines: [faker_1.faker.location.country(), faker_1.faker.location.country()],
        ...
        delivery_time: faker_1.faker.number.int({ min: 10, max: 60 }),
